...
public class EShopDbContext : IdentityDbContext<ApplicationUser, ApplicationRole, string>
{
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        builder.Entity<ProductCategory>(entity =>
        {
            ...
            entity.HasData(new ProductCategory(1, 1),
        ...
        builder.Entity<Category>(entity =>
        {
...

            {
                ...
                entity.HasData(new Product("Laptop", "16GB RAM, 512GB SSD", 1500.00m, "/images/products/laptop.jpg") { Id = 1, IsActive = true, IsDeleted = false },
            ...
            var adminUser = new ApplicationUser("Ali", "Cabbar", new DateTime(1999, 1, 1), GenderType.Male)
            {
                Id = "653fc02d-1cc9-4b45-a6d6-197cd6ce5e1f",
            ...
            var normalUser = new ApplicationUser("Esin", "Çelik", new DateTime(1999, 1, 1), GenderType.Female)
            {
                Id = "2185a6f7-095c-4c21-accd-a90118789259",
